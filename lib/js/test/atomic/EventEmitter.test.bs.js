...
Zora.test("EventEmitter", (function (t) {
        ...
        t.test("'Emitter.removeListener' should remove the event listener", (function (t) {
                ...
                var listeners = new Events.EventEmitter().on(EventEmitterTestLib$NodeJs.Emitter1.Events.text, eventListener).removeListener(EventEmitterTestLib$NodeJs.Emitter1.Events.text, eventListener).listeners(EventEmitterTestLib$NodeJs.Emitter1.Events.text);
        ...
        t.test("'Emitter.off' should remove the event listener", (function (t) {
                ...
                var listeners = new Events.EventEmitter().on(EventEmitterTestLib$NodeJs.Emitter1.Events.text, eventListener).off(EventEmitterTestLib$NodeJs.Emitter1.Events.text, eventListener).listeners(EventEmitterTestLib$NodeJs.Emitter1.Events.text);
                t.equal(listeners.length, 0, "");
              }));
        t.test("'Emitter.emit' should execute each listener for the correct event", (function (t) {
                ...
                var emitter = new Events.EventEmitter().on(EventEmitterTestLib$NodeJs.Emitter1.Events.integer, listener1).on(EventEmitterTestLib$NodeJs.Emitter1.Events.integer, listener2);
        ...
        t.test("'Emitter.removeAllListeners' should remove all event listeners", (function (t) {
                ...
                var emitter = new Events.EventEmitter().on(EventEmitterTestLib$NodeJs.Emitter1.Events.text, eventListener).on(EventEmitterTestLib$NodeJs.Emitter1.Events.text, eventListener).on(EventEmitterTestLib$NodeJs.Emitter1.Events.text, eventListener);
